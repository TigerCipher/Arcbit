...
void Log::SetLevel(Channel channel, spdlog::level::level_enum level) { GetLogger(channel).set_level(level); }
...
spdlog::logger& Log::GetLogger(Channel channel) { return *s_Loggers[static_cast<size_t>(channel)]; }
} // namespace Arcbit
