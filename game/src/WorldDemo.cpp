...
class WorldDemo : public Application
{
public:
    WorldDemo() : Application({.Title = "Arcbit", .Width = 1920, .Height = 1080}) {}
...
// Entry point — main.cpp calls this when ARCBIT_DEMO_WORLD is the selected demo.
void RunWorldDemo()
{
    WorldDemo game;
    game.Run();
